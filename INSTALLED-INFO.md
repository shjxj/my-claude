...
> 更新日期：2026-05-21 | 涵盖 Claude Code 核心能力、所有 CLI 命令、内置斜杠命令、已安装插件（10个）与技能、MCP 服务（13个）的详细中文说明
>
...
### 6.6 ui-ux-pro-max — UI/UX 设计增强 🆕

**路径**：`~/.claude/skills/ui-ux-pro-max/`
**功能**：UI/UX 设计增强，涵盖前端设计、组件库最佳实践、交互优化、暗黑模式、响应式设计等。
**用法**：在对话中自然提及 UI/UX 设计需求时自动触发。
